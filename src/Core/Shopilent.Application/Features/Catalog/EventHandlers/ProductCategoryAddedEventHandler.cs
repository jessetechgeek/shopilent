...
internal sealed class
    ProductCategoryAddedEventHandler : INotificationHandler<DomainEventNotification<ProductCategoryAddedEvent>>
{
    ...
    public async Task Handle(DomainEventNotification<ProductCategoryAddedEvent> notification,
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex,
                "Error processing ProductCategoryAddedEvent for ProductId: {ProductId}, CategoryId: {CategoryId}",
